          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="relative w-6 h-6">
               ...
               <svg viewBox="0 0 24 24" fill="none" className="w-full h-full text-white" stroke="currentColor" strokeWidth="1.5">
                  <path d="M12 2L2 22h20L12 2zm0 3.5L18.5 20h-13L12 5.5z" strokeLinecap="round" strokeLinejoin="round" />
                  <circle cx="12" cy="13" r="3" className="fill-white/10" stroke="none" />
               </svg>
            </div>
            <span className="text-sm font-semibold text-white tracking-tight">Trinity Labs AI</span>
          </Link>
